...
function $twig$filter$escape$$($env$$2_s$$inline_16_str$$inline_147$$, $sb$$inline_17_value$$60$$, $i$$inline_18_opt_type$$6$$, $JSCompiler_temp_const$$137_opt_charset$$, $JSCompiler_temp_const$$136_opt_autoescape$$) {
  if($JSCompiler_temp_const$$136_opt_autoescape$$ && $sb$$inline_17_value$$60$$ instanceof $twig$Markup$$) {
  ...
  if($twig$filter$escape$Type$JAVASCRIPT$$ === $i$$inline_18_opt_type$$6$$) {
    ...
    if($env$$2_s$$inline_16_str$$inline_147$$.quote) {
      ...
      for($i$$inline_18_opt_type$$6$$ = 0;$i$$inline_18_opt_type$$6$$ < $env$$2_s$$inline_16_str$$inline_147$$.length;$i$$inline_18_opt_type$$6$$++) {
        var $JSCompiler_temp$$139_c$$inline_143_ch$$inline_19$$ = $env$$2_s$$inline_16_str$$inline_147$$.charAt($i$$inline_18_opt_type$$6$$), $cc$$inline_20_rv$$inline_144$$ = $JSCompiler_temp$$139_c$$inline_143_ch$$inline_19$$.charCodeAt(0);
        $JSCompiler_temp_const$$137_opt_charset$$ = $sb$$inline_17_value$$60$$;
        $JSCompiler_temp_const$$136_opt_autoescape$$ = $i$$inline_18_opt_type$$6$$ + 1;
        var $JSCompiler_temp$$138_cc$$inline_145$$;
        if(!($JSCompiler_temp$$138_cc$$inline_145$$ = $goog$string$specialEscapeChars_$$[$JSCompiler_temp$$139_c$$inline_143_ch$$inline_19$$])) {
          if(!(31 < $cc$$inline_20_rv$$inline_144$$ && 127 > $cc$$inline_20_rv$$inline_144$$)) {
            if($JSCompiler_temp$$139_c$$inline_143_ch$$inline_19$$ in $goog$string$jsEscapeCache_$$) {
              $JSCompiler_temp$$139_c$$inline_143_ch$$inline_19$$ = $goog$string$jsEscapeCache_$$[$JSCompiler_temp$$139_c$$inline_143_ch$$inline_19$$]
            }else {
              if($JSCompiler_temp$$139_c$$inline_143_ch$$inline_19$$ in $goog$string$specialEscapeChars_$$) {
                $JSCompiler_temp$$139_c$$inline_143_ch$$inline_19$$ = $goog$string$jsEscapeCache_$$[$JSCompiler_temp$$139_c$$inline_143_ch$$inline_19$$] = $goog$string$specialEscapeChars_$$[$JSCompiler_temp$$139_c$$inline_143_ch$$inline_19$$]
              }else {
                $cc$$inline_20_rv$$inline_144$$ = $JSCompiler_temp$$139_c$$inline_143_ch$$inline_19$$;
                $JSCompiler_temp$$138_cc$$inline_145$$ = $JSCompiler_temp$$139_c$$inline_143_ch$$inline_19$$.charCodeAt(0);
                if(31 < $JSCompiler_temp$$138_cc$$inline_145$$ && 127 > $JSCompiler_temp$$138_cc$$inline_145$$) {
                  $cc$$inline_20_rv$$inline_144$$ = $JSCompiler_temp$$139_c$$inline_143_ch$$inline_19$$
                }else {
                  if(256 > $JSCompiler_temp$$138_cc$$inline_145$$) {
                    if($cc$$inline_20_rv$$inline_144$$ = "\\x", 16 > $JSCompiler_temp$$138_cc$$inline_145$$ || 256 < $JSCompiler_temp$$138_cc$$inline_145$$) {
                      $cc$$inline_20_rv$$inline_144$$ += "0"
                    }
                  }else {
                    $cc$$inline_20_rv$$inline_144$$ = "\\u", 4096 > $JSCompiler_temp$$138_cc$$inline_145$$ && ($cc$$inline_20_rv$$inline_144$$ += "0")
                  }
                  $cc$$inline_20_rv$$inline_144$$ += $JSCompiler_temp$$138_cc$$inline_145$$.toString(16).toUpperCase()
                }
                $JSCompiler_temp$$139_c$$inline_143_ch$$inline_19$$ = $goog$string$jsEscapeCache_$$[$JSCompiler_temp$$139_c$$inline_143_ch$$inline_19$$] = $cc$$inline_20_rv$$inline_144$$
              }
            }
          }
          $JSCompiler_temp$$138_cc$$inline_145$$ = $JSCompiler_temp$$139_c$$inline_143_ch$$inline_19$$
        }
        $JSCompiler_temp_const$$137_opt_charset$$[$JSCompiler_temp_const$$136_opt_autoescape$$] = $JSCompiler_temp$$138_cc$$inline_145$$
      }
...
$goog$exportSymbol$$("twig.contains", function($haystack$$, $needle$$) {
  var $JSCompiler_temp$$141_JSCompiler_temp$$142_key$$inline_151$$;
  if($goog$isArray$$($haystack$$)) {
    $JSCompiler_temp$$141_JSCompiler_temp$$142_key$$inline_151$$ = 0 <= $goog$array$indexOf$$($haystack$$, $needle$$)
  }else {
    if($goog$isString$$($haystack$$)) {
      $JSCompiler_temp$$141_JSCompiler_temp$$142_key$$inline_151$$ = -1 != $haystack$$.indexOf($needle$$) && ("" !== $needle$$ || "" === $haystack$$)
    }else {
      a: {
        for($JSCompiler_temp$$141_JSCompiler_temp$$142_key$$inline_151$$ in $haystack$$) {
          if($haystack$$[$JSCompiler_temp$$141_JSCompiler_temp$$142_key$$inline_151$$] == $needle$$) {
            $JSCompiler_temp$$141_JSCompiler_temp$$142_key$$inline_151$$ = !0;
            break a
          }
        }
        $JSCompiler_temp$$141_JSCompiler_temp$$142_key$$inline_151$$ = !1
      }
    }
  }
  return $JSCompiler_temp$$141_JSCompiler_temp$$142_key$$inline_151$$
});
...
$goog$exportSymbol$$("twig.filter.split", function($string$$3$$, $separator$$1$$, $limit$$1$$) {
  return 0 === $limit$$1$$ || 1 === $limit$$1$$ ? [$string$$3$$] : 0 > $limit$$1$$ ? $string$$3$$.split($separator$$1$$).slice(0, $limit$$1$$) : 1 < $limit$$1$$ ? $string$$3$$.split($separator$$1$$, $limit$$1$$ - 1).concat($string$$3$$.split($separator$$1$$).slice($limit$$1$$ - 1).join($separator$$1$$)) : $string$$3$$.split($separator$$1$$)
});
